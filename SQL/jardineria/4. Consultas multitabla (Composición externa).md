# 🔗 Consultas Multitabla con Composición Externa

Este documento forma parte del portafolio técnico de Angel y presenta una colección de consultas SQL que utilizan **composición externa** para explorar relaciones entre múltiples tablas del modelo relacional de Jardinería. El enfoque está en aplicar cláusulas como `LEFT JOIN`, `RIGHT JOIN` y `FULL OUTER JOIN` (cuando sea compatible) para identificar registros que no tienen correspondencia directa entre entidades.
...
- Analizar relaciones jerárquicas entre empleados y jefes.
...
- `cliente`: información de clientes y sus representantes.
...
Este modelo permite realizar análisis detallados sobre la cobertura comercial, la eficiencia operativa y la estructura organizacional.

## 🎯 Propósito del ejercicio

El propósito de este archivo es:

- Aplicar técnicas de composición externa para detectar ausencias o relaciones incompletas.
- Explorar cómo se comportan las entidades cuando no hay correspondencia directa.
...
```
<p align="center">
<img src="./imagenes/externa 1.png" alt="consulta externa 1" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 2.png" alt="consulta externa 2" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 3.png" alt="consulta externa 3" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 4.png" alt="consulta externa 4" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 5.png" alt="consulta externa 5" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 7.png" alt="consulta externa 7" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 9.png" alt="consulta externa 9" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 10.png" alt="consulta externa 10" width="300"/>
...
```
<p align="center">
<img src="./imagenes/externa 11.png" alt="consulta externa 11" width="300"/>
